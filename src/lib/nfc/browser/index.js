    ...
    constructor() {
        ...
        window.mock.addCard = (
            ...
            if (typeof credit !== "number") {
                throw new Error(
                    "credit should not be passed into nfc.cardToData"
                );
            }

            if (typeof version !== "number") {
                throw new Error(
                    "version should not be passed into nfc.cardToData"
                );
            }
            ...
            console.warn(
                `Writing card ${name} to local storage : ${cardId}(${credit})`
            );
        ...
        window.mock.scan = name => {
            if (!localStorage.hasOwnProperty("mocked-cards")) {
                throw new Error(
                    "You need to use mock.addCard to create a mocked card first"
                );
            }
