...
const purchaseFields = [
    ...
    { title: 'Support', reducer: p => p.wallet.physical_id ? `${p.wallet.logical_id} (${p.wallet.physical_id})` : p.wallet.logical_id },
    { title: 'Acheteur', reducer: p => p.wallet.user ? `${p.wallet.user.firstname} ${p.wallet.user.lastname}` : 'Anonyme' },
    {
        title: 'Article',
...
const withdrawalFields = [
    ...
    { title: 'Support', reducer: w => w.wallet.physical_id ? `${w.wallet.logical_id} (${w.wallet.physical_id})` : w.wallet.logical_id },
    { title: 'Acheteur', reducer: w => w.wallet.user ? `${w.wallet.user.firstname} ${w.wallet.user.lastname}` : 'Anonyme' },
...
const reloadFields = [
    ...
    { title: 'Support', reducer: r => r.wallet.physical_id ? `${r.wallet.logical_id} (${r.wallet.physical_id})` : r.wallet.logical_id },
    { title: 'Acheteur', reducer: r => r.wallet.user ? `${r.wallet.user.firstname} ${r.wallet.user.lastname}` : 'Anonyme' },
